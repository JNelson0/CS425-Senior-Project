...
export default function SettingsToggles({toggle, setS, settingsOpen}) {
    const [redirectTo, setRedirectTo] = useState()

    const [error, setError] = useState()
    const {logoutUser, generateGoogleTokensQuery} = useGlobalContext()
    ...
    return (
        <div className={"settings " + (settingsOpen && "active")}>
